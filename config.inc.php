<?php
//stability api秘钥
define('STABILITYAI_APP_KEY','sk-XPB7yWuYn9C6AmBQ8KkgX1H4wakX4VG7XuIJWnT3ePvYGfw3');//use your own api key
...
define('OPENAI_API_KEY','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');//use your own api key
